    ...
    <form id="form1" class="row g-3">
            ...
            <style>
                /*#canvasContainer {
                    ...
                    height: 690px;
                    cursor: pointer;*/
                   /* position: absolute; /* Establece la posición fija */
                    /*top: 52%; /* Coloca el elemento en el 50% de la altura de la pantalla */
                    /*left: 50%; /* Coloca el elemento en el 50% del ancho de la pantalla */
                    /*transform: translate(-32%, -60%); /* Mueve el elemento hacia arriba y la izquierda en la mitad de su propio tamaño */
                /*}*/
                /*#canvasContainer {
                  background-image: url(img/logo-sofia.jpg);
                  background-repeat: no-repeat;
        ...
        max-height: 10vh;
                ...
                #Ruleta {
                    width: 85vw;
                    max-width: 700px; /* ajustar el valor máximo según tus necesidades */
                    height: 85vw;
                    max-height: 700px; /* ajustar el valor máximo según tus necesidades */
                }
                </style>
                ...
                <div class="col-md-12">
                  <div class="row">
                    <div class="col-12 text-center">  
                      <h1 class="text-center">SOFIA TE PREMIA</h1>
                    </div>
                    <div class="col-12 text-center" onclick="leerElementos()">
                      <br/>
...
<script>
    ...
    function leerElementos() {
        ...
        colores.sort(function() { return 0.5 - Math.random() });
