                                        ...
                                        <table class="table table-striped table-sm fs--1 mb-0">
                                            <thead>
                                              <tr>
                                                ...
                                                <th class="sort border-top ps-3" data-sort="email">Premio</th>
                                                ...
                                                <th class="sort border-top ps-3" data-sort="rol">Ciudad</th>
                                                <th class="sort border-top ps-3" data-sort="fecha_creado">Fecha Creado</th>
                                            ...
                                            <tbody class="list">
                                                @foreach($DatosView['usuarios'] as $item)
                                                    <tr>
                                                        ...
                                                        <td class="align-middle ps-3 ESTADO">{{ $item->estado }}</td>
                                                        <td class="align-middle ps-3 MERCADO">{{ $item->id_mercado }}</td>
                                                        <td class="align-middle ps-3 ROL">{{ $item->id_rol }}</td>
                                                        <td class="align-middle ps-3 FECHA_CREADO">{{ $item->created_at }}</td>
